...
-- ==========================================================================
-- Locations, factions, items, lore (hand-curated first pass from the notes)
-- ==========================================================================

insert into public.locations (id, campaign_id, name, kind, "desc", region, ruler, notes) values
  ('foi-l1',  'fist-of-ilmater', 'Triboar',            'Town',       'Seat of the Shields of the Crying God, liberated by the party in the Battle of Triboar. The guild hall holds floors of teleportation, dragons, and competence, each tended by an undead saint.', 'Sword Coast North', null, 'Weaver''s office sits above the guild floors. Teleportation circles cost money.'),
  ('foi-l2',  'fist-of-ilmater', 'Phandalin',          'Town',       'Frontier town of townmaster Harbin Wester, Sister Garaele, and the Shrine of Luck. Booming again now the mine has reopened.', 'Sword Coast North', 'Harbin Wester', 'The party''s rescued Gragmaw goblins serve as its militia under Targor Bloodsword.'),
  ('foi-l3',  'fist-of-ilmater', 'Longsaddle',         'Town',       'Home of the Harpell wizard family and, formerly, Trade Off''s headquarters and slaughterhouse. An illusion dome upheld by the Harpells covers it.', 'Sword Coast North', 'The Harpells', 'Ostever''s Slaughterhouse hid Trade Off''s dungeon. Penelope Harpell blew the HQ sky-high.'),
  ('foi-l4',  'fist-of-ilmater', 'Wave Echo Cave',     'Mine',       'Lost mine of the Phandelver''s Pact, home of the Forge of Spells and its beholder Guardian. A new Pact with the dwarves restarted the mine, with the guild taking a percentage.', 'near Phandalin', null, 'Where Iarno fell, and where the clown revealed himself as Mephistopheles.'),
  ('foi-l5',  'fist-of-ilmater', 'Gragmaw Castle',     'Castle',     'Ruined castle held by King Grol''s goblins, where Gundren Rockseeker was held and interrogated by the drow priestess Vyerith.', 'Sword Coast North', null, 'Its north-east tower was sealed by a magical sun-and-moon lock.'),
  ('foi-l6',  'fist-of-ilmater', 'Barovia',            'Domain of Dread', 'Strahd von Zarovich''s misty prison-realm, entered by the party in session 77 and escaped in session 146. The Vistani alone walk its mists freely.', 'The Mists', 'Strahd von Zarovich (dec.)', 'The mists smell of rotten glass. Leaving without a talisman means days of suffocation.'),
  ('foi-l7',  'fist-of-ilmater', 'Vallaki',            'Town',       'Palisaded town of forced weekly festivals under Baron Vargas Vallakovich. The party unmasked Lady Wachter as a succubus here — before werewolves destroyed the town entirely.', 'Barovia', null, 'Its children were carried to the wolf den; the party brought the survivors to Krezk.'),
  ('foi-l8',  'fist-of-ilmater', 'Castle Ravenloft',   'Castle',     'Strahd''s castle, seized late in the saga by Baba Lysaga and her fiendish backers. Crawled from catacombs to throne room, where both witch and vampire finally fell.', 'Barovia', null, 'A pulsing crystal heart powered its defences until the party destroyed it.'),
  ('foi-l9',  'fist-of-ilmater', 'The Amber Temple',   'Temple',     'A cold, dark temple where ancient wizards sealed arch evils in amber sarcophagi — rumored to be where Strahd became a vampire. Kept by the amnesiac lich Exethanter.', 'Barovia', null, 'Barendd refused the Corpse Star''s bargain here. Rahadin''s stabbed body was found at its door.'),
  ('foi-l10', 'fist-of-ilmater', 'Krezk',              'Village',    'Walled settlement of mayor Dmitry Kreskov, near the blessed pool of St. Markovia and the Abbey where the mad Abbot built a bride for Strahd.', 'Barovia', 'Dmitry Kreskov', 'Vallaki''s rescued children were brought here.'),
  ('foi-l11', 'fist-of-ilmater', 'Neverwinter',        'City',       'City of Lord Protector Dagult Neverember. The party stayed at The Moonstone Mask and researched the Shadowfell at the House of Knowledge.', 'Sword Coast North', 'Dagult Neverember', 'Teleportation-circle users owe the city a day of monster-hunting.'),
  ('foi-l12', 'fist-of-ilmater', 'Grudd Haug',         'Giant Den',  'Chief Guh''s den, built to dam a river — a hub where hill giants and goblinoids kidnapped people to eat or sell. Cleared by the party.', 'Sword Coast North', 'Chief Guh (dec.)', 'The survivor Hruk revealed Theldin was sold to fire giants of a cult headed for the Shadow of Mount Hotenow.'),
  ('foi-l13', 'fist-of-ilmater', 'Mount Hotenow',      'Volcano',    'The volcano whose eruption caused the Ruining fifty years ago. It has an echo of itself inside the Shadowfell, with the Starforge amid an acid lake near its top.', 'near Neverwinter', null, 'Reached through a one-way dungeon of seven iron doors, past the dragon Calumnus.'),
  ('foi-l14', 'fist-of-ilmater', 'Port Llast',         'Port Town',  'Fallen to corrupted, red-eyed frost giants and two dragons who arrived aboard the giant ship Krigvind. The fog-shrouded town is filled with corpses.', 'north of Neverwinter', null, null);

insert into public.factions (id, campaign_id, name, sigil, "desc", allegiance) values
  ('foi-f1', 'fist-of-ilmater', 'Shields of the Crying God', 'S',  'The party''s heroes guild in Triboar, led by Weaver — the last surviving hero guild; the rest were wiped out by the SpellPlague. Its ranks include the Elite Four and undead saints.', 'Ally'),
  ('foi-f2', 'fist-of-ilmater', 'The Vistani',               'V',  'People of stories who alone can walk the mists between Domains of Dread. They keep the dusk elves close and would not betray Strahd — but Madam Eva''s talisman led the party home.', 'Neutral'),
  ('foi-f3', 'fist-of-ilmater', 'Keepers of the Feather',    'K',  'The were-raven Martikov family — Urwin at the Blue Water Inn, Davian at the Wizard of Wines — who long protected Vallaki and pledged their wings against Strahd.', 'Ally'),
  ('foi-f4', 'fist-of-ilmater', 'Zhentarim',                 'Z',  'The Black Network: mercenaries, spies and assassins who hunted the Gauntlets of Vonindod alongside Mephistopheles'' fiends. Their soldiers killed Karn at Nesmé.', 'Hostile'),
  ('foi-f5', 'fist-of-ilmater', 'The Black Spider',          'B',  'Drow-fronted operation that sought the Forge of Spells through agents like Vyerith and Nazznar — ultimately revealed as a disguise of the archdevil Mephistopheles.', 'Hostile'),
  ('foi-f6', 'fist-of-ilmater', 'The Harpers',               'H',  'Elven investigators who police the North. Ariana Riverlost''s trio took Orcsplitter into safekeeping for Weaver in exchange for promised magic items.', 'Ally'),
  ('foi-f7', 'fist-of-ilmater', 'Cult of Gomoth',            'G',  'A cult of fire beings formed by the mad fire giant Gomoth to awaken the primordial Maegera the Inferno. Its giants bought Theldin and marched for the Shadow of Mount Hotenow.', 'Hostile'),
  ('foi-f8', 'fist-of-ilmater', 'Trade Off',                 'T',  'Smuggling company out of Longsaddle led by Kriv, which Tillem unknowingly served as a delivery boy. It kidnapped Wom, and was destroyed by the party and Penelope Harpell.', 'Hostile');

insert into public.items (id, campaign_id, name, kind, "desc") values
  ('foi-i1', 'fist-of-ilmater', 'The Sunsword',             'Weapon',     'Sergey''s blade — ''only sun can kill me'', wrote Strahd. Found inside a scarecrow at the Abbey; Barendd drove it through Strahd''s heart in his coffin.'),
  ('foi-i2', 'fist-of-ilmater', 'Tome of Strahd',           'Book',       'Strahd''s ancient tome, found above the Abbot''s hearth, revealing his weaknesses. Cursed to make its reader its protector — a curse Oliver could not break.'),
  ('foi-i3', 'fist-of-ilmater', 'Symbol of Ravenkind',      'Holy Relic', 'A powerful force of good and protection from Madam Eva''s reading, found in an adamantine tower-room of Castle Ravenloft.'),
  ('foi-i4', 'fist-of-ilmater', 'Orcsplitter',              'War Axe',    'King Torhild Flametongue''s legendary axe. It filled Mort and Fynn with unrest as unworthy wielders but accepted Barendd; now with the Harpers for safekeeping.'),
  ('foi-i5', 'fist-of-ilmater', 'Karn''s Ruby',             'Gem',        'Taken from Karn''s shattered body after his last stand at Nesmé. When Fynn held it, it felt warm and filled with love.'),
  ('foi-i6', 'fist-of-ilmater', 'The Mist Talisman',        'Talisman',   'Prepared by Madam Eva and keyed to the party''s home world. Cold to the touch, it tugged Fynn along the right path through the mists.');

insert into public.lore (id, campaign_id, title, text) values
  ('foi-lo1', 'fist-of-ilmater', 'The Shields of the Crying God', 'The last surviving heroes guild — every other was wiped out by the SpellPlague. Ilmater, the Crying God, weeps for those who suffer; his shields carry the suffering instead. Karn died as one.'),
  ('foi-lo2', 'fist-of-ilmater', 'The Mists and the Domains of Dread', 'The mists ferry the unwilling between Domains of Dread and smell of rotten glass. Only the Vistani walk them freely; a mist talisman keyed to a world can lead you home — if you don''t suffocate first.'),
  ('foi-lo3', 'fist-of-ilmater', 'The Balance of the Hells', 'Mephistopheles has made demons and devils fight together, breaking the balance. He gathers power in every world — obsidian obelisks pulled through portals, dread domains seeded, dragons stolen — for a next step no one has named.');

-- ==========================================================================
-- Sessions 31–178 (generated from the play notes)
-- ==========================================================================

insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s31', 'fist-of-ilmater', 31, 'Awakening at the Guild', null, null, null, 'Woke up in the guild.
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s32', 'fist-of-ilmater', 32, 'The Funeral of Long Wang', null, null, null, '“Long wang is overleden”
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s33', 'fist-of-ilmater', 33, 'The Road to Gragmaw Castle', null, null, null, 'We are in Conyberry, a town left in ruins after being attacked by barbarians. It is night. The date is Kythorn 29.
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s35', 'fist-of-ilmater', 35, 'Rescue of Gundren Rockseeker', null, 'Flamerule 1', null, '*Flamerule 1*  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s36', 'fist-of-ilmater', 36, 'Visions in Phandalin', null, 'Flamerule 2', null, 'Flamerule 2  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s37', 'fist-of-ilmater', 37, 'Giants on the Longsaddle Road', null, 'Flamerule 6', null, 'Flamerule 5 Still  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s37b', 'fist-of-ilmater', 37, 'The Circle of Thunder', null, null, null, 'We decided to help Peter with his wereboar infestation.
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s38', 'fist-of-ilmater', 38, 'Kriv''s Ultimatum', null, 'Flamerule 8', null, '**Kriv** (leader of Trade Off) wants to have Tillem killed, because he ran away from the company (literally called out “off with his head”). **Boldo**’s proposition is: do some work with your group in exchange for your life and Wom’s.
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s39', 'fist-of-ilmater', 39, 'The Leonin''s Blessing', null, null, null, 'The day is still Flamerule 8. During the previous session we met Kriv around noon. We started thinking of ideas to gain Lightning Resistance, as advised by Weaver. We decided to go to the wereboars in hopes of help.
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s40', 'fist-of-ilmater', 40, 'Fire at the Trade Off', null, 'Flamerule 8', null, 'Still Flamerule 8.
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s41', 'fist-of-ilmater', 41, 'Beyond the Blue Barrier', null, 'Flamerule 8', null, 'Still Flamerule 8
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s42', 'fist-of-ilmater', 42, 'One Beating Heart', null, 'Flamerule 8', null, 'Still Flamerule 8
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s43', 'fist-of-ilmater', 43, 'Athos Settles the Score', null, 'Flamerule 9', null, '*Still fucking* **Flamerule 8**
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s44', 'fist-of-ilmater', 44, 'Tillem''s Farewell', null, 'Flamerule 11', null, '**Flamerule 11**  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s45', 'fist-of-ilmater', 45, 'Orcs on the Conyberry Road', null, 'Flamerule 14', null, '**Flamerule 14**  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s46', 'fist-of-ilmater', 46, 'The Tower of Storms', null, 'Flamerule 17', null, '**Flamerule 17**  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s47', 'fist-of-ilmater', 47, 'The Heart of the Storm', null, null, null, 'Repeated flavor text of the tower: Partly open to elements. Floating still beating heart emanates the light.
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s48', 'fist-of-ilmater', 48, 'Secrets of the Dragon Barrow', null, null, null, 'We spent the night at the Tower of Storms. Karn decided to “sleep” at the horses, while Mort, Ed, (Theothor) and Fynn spent the night inside of the lighthouse. Ed attempted to make a fire, but it blew up in his face. As Ed watched the sunset, Mort and Fynn fell asleep, but Fynn woke up from Ed’s loud snoring and went to sleep downstairs.
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s49', 'fist-of-ilmater', 49, 'The Dragon Slayer''s Rest', null, 'Flamerule 18', null, '**Flamerule 18**  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s50', 'fist-of-ilmater', 50, 'The Thing in the Veins', null, 'Flamerule 18', null, '**Flamerule 18**  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s51', 'fist-of-ilmater', 51, 'Storming the Shrine of Savras', null, null, null, '**Flamerule 19 - Night**  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s52', 'fist-of-ilmater', 52, 'Agatha''s Answer', null, null, null, '**Still Flamerule 19 - Late Night**  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s53', 'fist-of-ilmater', 53, 'The Necromancer of Old Owl Well', null, null, null, 'Decided to head to Old Owl Well, because it’s on the way and one of the last side quests we still have laying around.  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s54', 'fist-of-ilmater', 54, 'Into Wave Echo Cave', null, 'Flamerule 20', null, '**Flamerule 20**  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s55', 'fist-of-ilmater', 55, 'The Flameskull''s Vigil', null, 'Flamerule 21', null, '**Flamerule 21**  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s56', 'fist-of-ilmater', 56, 'The Black Spider Unmasked', null, 'Flamerule 21', null, '**Flamerule 21**  
abj and conj  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s57', 'fist-of-ilmater', 57, 'The Archdevil''s Disguise', null, 'Flamerule 21', null, '**Flamerule 21**  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s58', 'fist-of-ilmater', 58, 'A Party Divided', null, 'Flamerule 22', null, '**Flamerule 22**  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s59', 'fist-of-ilmater', 59, 'The Forge of Spells', null, 'Flamerule 22', null, '**Flamerule 22**  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s60', 'fist-of-ilmater', 60, 'Zombies in the Fungal Dark', null, null, null, 'Puff Balls. Lots of Fungi. Decided to go around, due to gas filling the air, poisoning Mort. Found skeletons, including some elepthant-like bones, but with thicker tails and without tusks. Spoke about this in the whisper jar. Hear from the darker side of the cavern an eerie growl. Fought some zombies, as well as a clot of hundreds of zombie parts. Radiant damage did extra damage. Defeated them.
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s61', 'fist-of-ilmater', 61, 'The Tamer of Demons', null, null, null, 'Mort was grabbed by a half dragon and dragged into the southern cavern. Carvings on the walls of miners. Many skeletons on the floor. Brass lanterns, but none are lit.
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s62', 'fist-of-ilmater', 62, 'Cryovain''s Ultimatum', null, null, null, 'Theothor came across someone who calls himself **Wild Tiger** and is just as cocky as Theothor. They both wanted golden sunglasses, asked Mort who looked better, Theothor won.
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s63', 'fist-of-ilmater', 63, 'The Road to Triboar', null, 'Flamerule 24', null, '**Flamerule 24**  
hier typt Karn
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s64', 'fist-of-ilmater', 64, 'Secrets of Ice Spire Hold', null, 'Flamerule 25', null, '**Flamerule 25**  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s65', 'fist-of-ilmater', 65, 'Let the World Burn', null, null, null, '“I no longer have a reason to live”. “I will take this world with me”. Children are just wyrmlings. They know no love. After us comes a new world. This world has gone to shit.
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s66', 'fist-of-ilmater', 66, 'Down the Mountain', null, null, null, 'Karn is landsliding down the mountain, holding on to a wall, standing on a broken piece of floor. He managed to pick up Gorgel’s heart on his way down.
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s67', 'fist-of-ilmater', 67, 'The Stolen Dragon', null, null, null, '*Only Karn knows this: Glyph of Warding put at the ground floor of the tower Karn is in. Chaotic Neutral 2x, 1x lawful evil. Not **Warforged** but **Anvilwrought**. Bombee Squad are the clean-up crew. Fixers, cleaners, assassins. Solve problems that other groups leave behind.*
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s68', 'fist-of-ilmater', 68, 'Runes of the Iron Manes', null, null, null, 'According to Jacob:  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s69', 'fist-of-ilmater', 69, 'Demons at the Bridge', null, 'Flamerule 27', 'https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image1.png', '**Flamerule 27**  
...
![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image1.png)

The yellow eyed creature is a Bulezau, a diseased animalistic manifestation of rage. It’s a type of demon:  
![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image2.png)  
...
![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image3.png)
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s70', 'fist-of-ilmater', 70, 'Campfire Confessions', null, 'Flamerule 28', null, 'Oliver healed Mort  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s71', 'fist-of-ilmater', 71, 'The Gates of Yartar', null, 'Flamerule 28', null, '**Flamerule 28**  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s72', 'fist-of-ilmater', 72, 'Shadows in Mornbryn''s Shield', null, 'Flamerule 29', 'https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image4.png', '***Cutscene time:***  
...
*![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image4.png)*
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s73', 'fist-of-ilmater', 73, 'The Black Network Strikes', null, null, null, 'Mort knows something about the **Zhentarim**:  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s74', 'fist-of-ilmater', 74, 'A Heart Gone Missing', null, 'Flamerule 30', 'https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image5.png', 'Oboth surrendered. We shackled him and took him back to the Inn in Mornbryn’s Shield. Shortly after the Bone Devils were seen, the mercs came into town saying they would get rid of them, started interrogating people, violently sometimes.  
...
![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image5.png)  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s75', 'fist-of-ilmater', 75, 'Death at Nesmé', null, null, null, 'WHAT HAPPENED?!
...
![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image6.png)')
on conflict (id) do nothing;

insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s77', 'fist-of-ilmater', 77, 'Into the Mists', null, 'Eleasis 1', 'https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image7.png', '**Eleasis 1**  
...
![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image7.png)  
*Clapperclaw*')
on conflict (id) do nothing;

insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s78', 'fist-of-ilmater', 78, 'The Weeping Village', null, 'Eleasis 5', 'https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image8.png', '**Eleasis 5**  
...
![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image8.png)  
***Mad Mary***
...
![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image9.png)  
*Morgantha*

*![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image10.png)*  
*Castle Ravenloft*')
on conflict (id) do nothing;

insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s79', 'fist-of-ilmater', 79, 'Voices in the Fog', null, null, 'https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image11.png', 'Woods are hunted by werecreatures and undead. Also lots of vampires. Deliberated among us, out of earshot of Morgantha. Fynn tried to sending stone to Floop, but a male voice responded with *“how did you get here? you need to help me”*.  
...
![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image11.png)  
*Morgantha’s “Horse”*
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s80', 'fist-of-ilmater', 80, 'Madam Eva''s Fortune', null, 'Eleasis 6', 'https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image12.png', '**Eleasis 5** Still  
...
![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image12.png)  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s81', 'fist-of-ilmater', 81, 'The Road to the Mill', null, 'Eleasis 6', 'https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image13.png', '**Eleasis 6**  
...
![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image13.png)  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s82', 'fist-of-ilmater', 82, 'Burning the Witch''s Mill', null, null, null, '*\< Bella & Ophelia*
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s83', 'fist-of-ilmater', 83, 'The Bleeding Moon', null, 'Eleasis 9', 'https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image14.png', 'Cracks appeared on the moon, with blood seeping out of it, turning into a waterfall of blood in the night’s sky. Stumbled upon an obelisk. Studied it:
...
| ![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image14.png) | ![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image15.png) | ![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image16.png) |
| :---- | :---- | :---- |
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s84', 'fist-of-ilmater', 84, 'The Gates of Vallaki', null, null, 'https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image17.png', 'Oliver cast Identify on one of the obelisks: made by a spell, very old, has a magical charge, but no idea what spell it’s charged with.
...
**![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image17.png)**
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s85', 'fist-of-ilmater', 85, 'Festival of the Blazing Sun', null, null, 'https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image18.png', 'Happy the Salesman, seems unable to tell us his real name (though that’s an assumption). Within Strahd’s castle is a great deal. A body that would make Theothor big.  
...
| ![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image18.png) | ![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image19.png) | ![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image20.png) |
| :---- | :---- | :---- |
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s86', 'fist-of-ilmater', 86, 'Riot at the Festival', null, 'Eleasis 10', null, '**Eleasis 10**  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s87', 'fist-of-ilmater', 87, 'The Coffin Maker''s Trap', null, null, null, 'Still **Eleasis10**  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s88', 'fist-of-ilmater', 88, 'The Succubus Unmasked', null, null, null, 'Still **Eleasis10**  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s89', 'fist-of-ilmater', 89, 'All Is NOT Well', null, null, null, 'Still **Eleasis10**  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s90', 'fist-of-ilmater', 90, 'The Dusk Elves'' Last King', null, 'Eleasis 10', 'https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image21.png', '**Still Eleasis 10**  
...
| ![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image21.png) | ![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image22.png) |
| :---- | :---- |
...
![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image23.png)  
Arabel
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s92', 'fist-of-ilmater', 92, 'Cultists Under Wachterhaus', null, 'Eleasis 11 - Morning', null, 'Fiona Wachter has been eating less and only red meat lately, according to the cook. Nothing else out of the ordinary. Cultist were holed up in a room with a summoning circle Some guy called Ernst was there and has now disappeared and reappeared as a incubus. Was supposedly the husband of the Fiona succubus. Searched all the dead cultists and found identical notes on all of them:
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s93', 'fist-of-ilmater', 93, 'Wings Over the Blue Water', null, 'Eleasis 11 - Early afternoon', null, 'Arrive at the Blue Water Inn.  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s94', 'fist-of-ilmater', 94, 'The Corruption of Saint Andral', null, 'Eleasis 11 - Late at night (around 11-ish)', null, 'Blue bones laid underneath the body of Father Luccian, which Milivoj stabbed with a certain dagger, causing the body to melt and fuse together with the bones, DM was losing it and a creature appeared from the mixture. Milivoj said he heard the voice of the morning god.  Was instructed to strike when the town went into chaos (which we did). A vile creature accompanied them: “I was supposed to be the new saint”. It’s…
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s95', 'fist-of-ilmater', 95, 'Bodies on the Lakeshore', null, 'Eleasis 12 - Morning', null, 'Decided to head north to the lake to the fishing docks north of Vallaki. Water is perfectly still, reflective. We look human in the reflections. Three row boats in the sand, one boat with one figure in it out on the lake.  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s96', 'fist-of-ilmater', 96, 'The Drunkard and the Kraken', null, 'Eleasis 13 - Early Afternoon', null, 'Got Victor to the veil. Fynn offered him Ury’s old cabin to stay in or told him to go to the guild in Triboar to offer his services. Human skull with red X painted across it, set on a stick at the veil.  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s97', 'fist-of-ilmater', 97, 'Arabel Saved from the Deep', null, 'Eleasis 13 - Afternoon?', 'https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image24.png', 'Had a bit of a tough time with killing the Kraken, but we were victorious. Girl one is called Charlie. The other is Arabel.
...
![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image24.png)
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s98', 'fist-of-ilmater', 98, 'Arrigal''s Bargain', null, 'Eleasis 14 - Afternoon', null, 'Camp was empty apart from the father Arrigal. We decided to try to get a favor from Arrigal and some collateral so he has to keep his word. That way we have some time to plan and possibly try to get the Healing Stone from Babalysaga, find what is hidden in Krezk or go to the cellars of Castle Ravenloft.  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s99', 'fist-of-ilmater', 99, 'The Walking House of Berez', null, 'Eleasis 15 - Morning', 'https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image25.png', 'We started traveling. The bleeding moon has gotten ever so slightly larger again. Set up camp. Fynn read the rest of the book on teleportation circles:
...
![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image25.png)![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image26.png)  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s100', 'fist-of-ilmater', 100, 'Cold Road to the Amber Temple', null, 'Eleasis 16', null, 'There is a monument that strongly resembles Ireena Kolyana. The inscription on the base of the monument says Marina, Taken by the Mists. Also found a scroll of Puppet in the old church. Marina and Ireena could be twin sisters maybe? Or an ancestor?
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s101', 'fist-of-ilmater', 101, 'Secrets in Golden Amber', null, 'Eleasis 17', 'https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image27.png', 'The statue’s head is covered in unexplainable darkness, a void. Mort broke down the statue, from which a creature fell. A fox-like creature.  
...
![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image27.png)![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image28.png)
...
![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image29.png)  
![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image30.png)  
![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image31.png)  
![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image32.png)  
![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image33.png)
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s102', 'fist-of-ilmater', 102, 'Whispers of the Nothics', null, 'Eleasis 17', null, 'Strahd Lore:  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s103', 'fist-of-ilmater', 103, 'Zryngala, the Howling Storm', null, 'Eleasis 17', null, 'Decided to check out the crevice in the wall. Some murials depict tentacles encircling kings and queens in the room behind it, as well as a much bigger Amber Sarcophagus. Will swing around to it later from above. A voice comes from the south of the hallway.
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s104', 'fist-of-ilmater', 104, 'Exethanter, Keeper of the Temple', null, 'Eleasis 18', null, 'Defeated the Amber golem and three fire skulls. Fynn summoned two hell hounds.  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s105', 'fist-of-ilmater', 105, 'Zhudun, the Corpse Star', null, 'Eleasis 18', null, 'In the Library:  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s106', 'fist-of-ilmater', 106, 'The Lycan Lance', null, 'Eleasis 19', 'https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image34.png', 'Mort now only has one eye. Exethanter heard some noises in the library, like people moving boxes. Why would someone move boxes of vampires into this temple? Sometimes people performed rituals before the sarcophagi and received powers. Tiny bit of evil then leaked out of the sarcophagus. Reminder: the temple is a place where evil is locked up. Considered the possibility of sealing the entrance.
...
![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image34.png)')
on conflict (id) do nothing;

insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s107', 'fist-of-ilmater', 107, 'Battle for the Vineyard', null, 'Eleasis 19', null, 'Defeated the Roc and the resurrected Vilnius  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s108', 'fist-of-ilmater', 108, 'Victory Among the Vines', null, 'Eleasis 21', 'https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image35.png', '*Tree Blight* has no immunities, resistances or vulnerabilities. We turned the tides and defeated all enemies. Confiscated a weapon from one of the druids:

![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image35.png)
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s110', 'fist-of-ilmater', 110, 'The Blight Horde', null, 'Eleasis 22', 'https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image36.png', '![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image36.png)')
on conflict (id) do nothing;

insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s111', 'fist-of-ilmater', 111, 'The Pool of Saint Markovia', null, 'Eleasis 22', null, 'Wake up in bed. A warm bed.
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s112', 'fist-of-ilmater', 112, 'The Abbot''s Perfect Bride', null, 'Eleasis 24', 'https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image37.png', 'They don’t want to talk about what they look like or how that came to be.
...
![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image37.png)
...
![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image38.png)  
![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image39.png)')
on conflict (id) do nothing;

insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s113', 'fist-of-ilmater', 113, 'Madness at the Abbey', null, 'Eleasis 24', null, 'Abbot still has the Tome of Strahd. Smoke from the Abbey. Only a single female scream remains coming from the Abbey. We busted through the gates. The courtyard is blackened, scorched. A disembodied Zygfred crawled towards us: “The Abbot went mad. He burned his daughter. He burned us. Flee before it’s…”. We barged into the room we were in before. We hear an orchestra playing, everything is black. The fireplace has exploded.  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s114', 'fist-of-ilmater', 114, 'The Cursed Tome', null, 'Eleasis 24', null, 'Decided to talk to the mayor before sleeping and leaving Krezk.
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s115', 'fist-of-ilmater', 115, 'The Fall of Vallaki', null, 'Eleasis 26', null, 'Elian Odomir was revived, party has gone. Legs are numb, unusable, you fall over, grabbed by dragon into air. Armor crashed, bones broken. Venomfang looks at you. The dead should remain so. Opens mouth, green fire, skin burns, eyeballs melt and life flashes before eyes.  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s117', 'fist-of-ilmater', 117, 'Into the Wolf Den', null, 'Eleasis 27', null, 'Two sleeping werewolves at the entrance of the wolfden on a ledge about 5ft up. Sounds of dripping and faint crying of children somewhere far away. Oliver cast Pass Without Trace. Gash in the ceiling, 10ft deep pool.
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s118', 'fist-of-ilmater', 118, 'Baba Lysaga Lives', null, 'Eleasis 28', null, '*Wom & Tillem lore drop:*  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s119', 'fist-of-ilmater', 119, 'The Road to Ravenloft', null, 'Eleasis 29', 'https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image40.png', 'Urwin is accompanied by a man with a great mustache, stern eyes, graying hair.  
Urwin told us:  
...
![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image40.png)![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image41.png)![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image42.png)

Drow woman is immune to Psychic Damage and Fire Damage. Defeated them.')
on conflict (id) do nothing;

insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s120', 'fist-of-ilmater', 120, 'The Last Guard of Vallaki', null, 'Eleasis 30', null, 'Came across a tombstone. It said: *“No victory for the golden, no for the moon. No prize for the torment, the birth of a vow.”* A zombie came out, right before Mort and Oliver wanted to dig himself out. Called himself “Tomwald the Shovel Stealing Zombie”.
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s121', 'fist-of-ilmater', 121, 'Ireena Among the Dead', null, 'Eleint 1', null, 'Piles of zombies inside. The body of Gadof Blinsky blocked the door, holding zombie heads in both hands. Hole in the roof wherein a creature disappeared. Also a hole in a barricade made over/behind the desk, in which we found Ireena Kolyana. She refused help at first, because we’re uncertain if we’re aligned with or against Strahd. Explained everything to her.  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s122', 'fist-of-ilmater', 122, 'Shadow Over the Fistani', null, 'Eleint 1', null, 'Splits up with the NPCs once more, as they went east of town and we went to the Fistani camp via the southern path.
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s123', 'fist-of-ilmater', 123, 'Ravens Before Ravenloft', null, 'Eleint 1', 'https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image43.png', 'Kasimir Velikov, King of the Dusk Elves, has bruises all over his body, but it''s mostly exhaustion. Decided to have a long rest in the building.

**Eleint 2**  
Received three potions from the Dusk Elves as reward:  
![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image43.png)  
![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image44.png)  
![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image45.png)
...
![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image46.png)
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s125', 'fist-of-ilmater', 125, 'Helga''s Secret Entrance', null, 'Eleint 4', null, 'Traveled for a day towards the castle, after deciding to trust Helga and take the secret entrance into the cellar.
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s126', 'fist-of-ilmater', 126, 'Kas the Betrayer', null, 'Eleint 5', null, 'We move through the secret tunnel, into the catacombs of Ravenloft. The keygen calls to Theothor, indicating where it wants to go. The keygen reminds him of rotten glass.  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s127', 'fist-of-ilmater', 127, 'The Dread Salesman', null, 'Eleint 5?', null, 'We bought some items from Happy the Dread Salesman. He also made statements hinting towards someone trying to communicate with us, such as: *“... can anyone hear me? Help...*  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s128', 'fist-of-ilmater', 128, 'Ambush for the Cryptkeeper', null, 'Eleint 5? I don’t know anymore', null, 'Barovian calendar consists of 12 months (who all sound similar to the dutch months).
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s129', 'fist-of-ilmater', 129, 'Waking the Royal Dead', null, 'Eleint 5? I don’t know anymore', null, 'When we decided to grant our allies a long rest within the catacombs, Moart disrupted the silence by yeeting a corpse out of its sarcophagus, awakening the bodies of King Barov and Queen Ravenovia.
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s130', 'fist-of-ilmater', 130, 'Spider of the Shaft', null, 'i AM LosT hhehhhelp me', 'https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image47.png', 'The big dragon was just an illusion. Went back to sleep. Woken up again by

The wall behind us closed and from holes in the walls containing Transmutation magic, water started pouring.

Adamantine in wall

![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image47.png)  
Typhon
...
On top of the tower we found a Clockwork Effigy: Pidlwick. He showed us a huge sword and a huge hammer.![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image48.png)')
on conflict (id) do nothing;

insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s131', 'fist-of-ilmater', 131, 'Voice of the Morninglord', null, 'Where am I? When am I?', 'https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image49.png', 'Altar with silver statuette of the icon of Ravenloft and a cloaked figure draped over the altar with a black mace at it’s feet. The statuette seems to be related to the Morninglord, which (together with Mother Night) is one of the gods, and not revered by evil people.  
...
| Icon of Ravenloft  *![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image49.png)![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image50.png)* |
| :---- |

| Mace of Terror  ![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image51.png)![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image52.png) |
| :---- |
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s132', 'fist-of-ilmater', 132, 'The Symbol of Ravenkind', null, 'There is no time. Only mist and darkness.', 'https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image53.png', 'Took a peak into the dining chamber. A caped figure is playing the organ. The table was set for 6 people.  
...
![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image53.png)![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image54.png)
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s133', 'fist-of-ilmater', 133, 'The Torture Chamber', null, 'Piddlewick NOOOOOOO!!!!!', null, 'Theothor, Oliver and Barendd landed on the roof of the chapel. Dangling from his ankles, held by Theothor, Barendd smashed through one of the windows and took Theothor inside with him. There, they encountered two zombies.  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s135', 'fist-of-ilmater', 135, 'The False Strahd', null, null, 'https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image55.png', 'Unlocked the center door. Turned out our allies split up (well, they all split up within the crypts). We got everyone back together and told them about Vasily’s death.  
...
![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image55.png)  
Yochlol
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s136', 'fist-of-ilmater', 136, 'Toward the Crystal Heart', null, null, null, 'We set out to the large tower in hopes of finding Strahd there, taking the three stealthiest of the allies with us: Ireena, Helga and Ezmerelda. But without Ireena.  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s137', 'fist-of-ilmater', 137, 'The Heart Destroyed', null, null, null, 'Killed the vampires and heart. Lost Aleksandru in the battle. Fynn fell down the tower and almost died.
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s138', 'fist-of-ilmater', 138, 'Crown of King Barov', null, null, null, 'Warm and softer than it should. No spark or magic flowing through the shard of heart. Theothor (violently) put some of Fynn’s broken ribs back into place.
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s139', 'fist-of-ilmater', 139, 'Road to the Throne', null, null, null, 'We defeated the Dragon Wirmlings and finally started our long rest, which got interrupted by some gray ooze, which knocked out Fynn.
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s140', 'fist-of-ilmater', 140, 'Escher and the Straw Beast', null, null, null, 'After defeating the painting and the Alkilith, we opened the door to the room on this floor and found a youthful man called Escher, who apparently ordered minions and was attached to the Guardian Portrait. *Escher has no bodily warmth.*  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s141', 'fist-of-ilmater', 141, 'Avatar of Mephistopheles', null, null, null, 'Fynn, reluctantly and… a bit poorly, plays a song on the lute to hype everyone up.
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s142', 'fist-of-ilmater', 142, 'The Fall of Baba Lysaga', null, null, null, '**Introduction about the Leonin:**  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s143', 'fist-of-ilmater', 143, 'Strahd''s True Death', null, null, null, 'We ended up in some endlessly white space, with only Rudolph and Rick alive.  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s144', 'fist-of-ilmater', 144, 'Waking Gertruda', null, null, null, 'We passed the room with the teleportation device. The orbs are no longer colored and the flame has been extinguished.  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s145', 'fist-of-ilmater', 145, 'Madam Eva''s Talisman', null, null, null, 'Found the wagons and mounts, which are still very much alive, though bloodied. Dead bandits strewn about the place. Found the Wolf Hunters, healed the mounts, burned Ezmerelda’s wagon as is usual for Vistani. Took her horse though.
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s146', 'fist-of-ilmater', 146, 'Out of the Mists', null, 'Eleint 24, apparently', null, 'Barendd decided to join us, but with the annotation that his story will probably take him to the underdark.
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s149', 'fist-of-ilmater', 149, 'Trail of Gargosh Blusterhelm', null, 'Eleint 25', null, 'In Westbridge:
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s150', 'fist-of-ilmater', 150, 'Ambush at the Hunting Axe', null, 'Eleint 27', null, 'Spoke to a merchant outside Beliard selling glass bottles and such: Owlbears nest in the halls. Pays 3GP a pound for glass shards from the Halls of the Hunting Axe.
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s151', 'fist-of-ilmater', 151, 'Orcsplitter and the Doppelganger', null, 'Eleint 27', null, 'Red glowing fist on the golems curses people. Defeated them. Sarcophagus was empty. Followed the secret passageway. A 15ft effigy of a dwarf clutching a waraxe on top of a dais. Written in dwarvish on it:  
*“Here lies His Noble Majesty*  
*King Torhild Flametongue.*  
*He raised a kingdom in the sun.*  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s153', 'fist-of-ilmater', 153, 'Scouting Grudd Haug', null, 'Eleint 28', null, '**Grudd Haugg scouting intel:**
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s154', 'fist-of-ilmater', 154, 'The Eye of Guh', null, 'Eleint 28', null, 'In this world, a group of fishes is called a “bear of fishes”. We offered the bodies of Smother and the Nilbogs to the bear, by chucking them into the river. Searched the smithy’s building. found nothing useful.
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s155', 'fist-of-ilmater', 155, 'Flight from the Plateau', null, 'Eleint 28', null, 'We took to the high ground of the plateau on which the tower stood. Unfortunately, enemies started climbing the cliff, wolves were thrown onto the plateau, boulders were thrown from the roofs and lightning was made by spell casters.
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s156', 'fist-of-ilmater', 156, 'Into the Pigsty', null, 'Eleint 29', null, 'Asked Floop for instructions:  
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s157', 'fist-of-ilmater', 157, 'The Fall of Grudd Haug', null, 'Eleint 29', null, 'Defeated everyone in Grudd Haug, save from one Hill Giant who switched sides. Turns out to be Hruk, the husband of Moog, whom we met on Flamerule 29 (Session 72) between Yartar and Mornbryn’s Shield. He told us the Fire Giants were part of some cult. Were on their way to the *Shadow* of Mount Hotenow. Also told us no information was written down, because nobody in Grudd Haug could read.')
on conflict (id) do nothing;

insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s158', 'fist-of-ilmater', 158, 'Whispers of Maegera', null, 'Eleint 29', null, 'Found the following things in Grudd Haug:
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s159', 'fist-of-ilmater', 159, 'A Dragon''s Mating Call', null, 'Eleint 30', null, 'Something moved inside the main building. We checked out the smaller buildings first. Shrouded in dust. Four dusky green creatures on top of the beds, asleep. We put up a Zone of Truth inside to see if they might’ve been friendly, but they turned out to just be zombies.
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s160', 'fist-of-ilmater', 160, 'The Myrmidon in the Well', null, 'Eleint 30', null, 'The water turned out to be a Water Myrmidon. Defeated it, along with a water elemental. We then found a lightning rod hidden above the fireplace in the dining room, making it the second of six rods we found.
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s161', 'fist-of-ilmater', 161, 'Six Rods of Lightning Keep', null, 'Eleint 30', null, '| To do |
| :---- |
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s163', 'fist-of-ilmater', 163, 'Death at Holrow Homestead', '8-8-2025', 'Highharvestide', null, '| **Attendees** | Fynn, Mort, Theothor |
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s164', 'fist-of-ilmater', 164, 'Port Llast Has Fallen', '15-08-2025', 'Marpenoth 1', null, '| **Attendees** | Fynn, Mort, Barendd |
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s165', 'fist-of-ilmater', 165, 'The Frozen Road', '23-8-2025', 'Marpenoth 1', null, '| **Attendees** | Oliver, Mort, Fynn |
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s166', 'fist-of-ilmater', 166, 'The Field of Flesh', '30-8-2025', 'Marpenoth 2', 'https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image56.png', '| **Attendees** | Barendd, Fynn, Mort, Oliver |
...
![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image56.png)')
on conflict (id) do nothing;

insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s167', 'fist-of-ilmater', 167, 'It Was Faldorn', '5-9-2025', 'Marpenoth 2', null, '| **Attendees** | Fort, Mynn, Boliver and Arendd |
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s168', 'fist-of-ilmater', 168, 'The Fireside Contests', '13-9-2025', 'Marpenoth 2', null, '| **Attendees** | Oliver, Barendd, Mort, Fynn |
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s169', 'fist-of-ilmater', 169, 'Faces in the Cavern', '3-10-2025', 'Marpenoth 3', null, '| **Attendees** | Theothor, Oliver, Mort, Fynn |
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s170', 'fist-of-ilmater', 170, 'The Golem''s Lever', '10-10-2025', 'Marpenoth 3', null, '| **Attendees** | Theothor, Oliver, Fynn |
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s171', 'fist-of-ilmater', 171, 'The Phantom Feast', '17-10-2025', 'Marpenoth 3', null, '| **Attendees** | Mort, Oliver, Fynn, Barendd? |
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s172', 'fist-of-ilmater', 172, 'The Untouchable Spirit', '24-10-2025', 'Marpenoth 3', null, '| **Attendees** | Mort, Oliver, Fynn |

Doesn’t take magical piercing damage')
on conflict (id) do nothing;

insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s173', 'fist-of-ilmater', 173, 'The Bronze Tablet', '31-10-2025', 'Marpenoth 3', null, '| **Attendees** | Barendd, Mort, Oliver, Fynn |
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s174', 'fist-of-ilmater', 174, 'Detour Through Elysium', '14-11-2025', 'Marpenoth 4', null, '| **Attendees** | Everyone! Huzzah! |
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s175', 'fist-of-ilmater', 175, 'Demon Apes on Pillars', '28-11-2025', 'Marpenoth 4', 'https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image57.png', '| **Attendees** | Mort, Theothor, Fynn, (Barendd?) |

![](https://nsemknuzupcnvctevgfd.supabase.co/storage/v1/object/public/entity-images/foi/image57.png)
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s176', 'fist-of-ilmater', 176, 'Mort''s Missing Shadow', '12-12-2025', 'Marpenoth 4', null, '| **Attendees** | Bort, Farendd, Mynn |
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s177', 'fist-of-ilmater', 177, 'Seven Iron Doors', '19-12-2025', 'Marpenoth 4', null, '| **Attendees** | Barendd, Theothor, Fynn |
...
insert into public.sessions (id, campaign_id, num, title, date, in_game_date, image_url, summary) values
  ('foi-s178', 'fist-of-ilmater', 178, 'The Last Guardian of Netheril', '9-1-2026', 'Marpenoth 5', null, '| **Attendees** | Mort, Fynn, Oliver |
